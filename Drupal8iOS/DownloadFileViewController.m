...
@property (weak, nonatomic) IBOutlet UIPickerView *downloadFilePicker;

@end

@implementation DownloadFileViewController
@synthesize downloadFilePicker;
...
- (void) configurePickerView {
    ...
    /* MAS:
     */
    pickerDataArray = [self getRemoteFiles]; // MAS: needs filenames to reveal widget in UIPickerView IB
